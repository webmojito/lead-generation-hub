...
router.get("/dashboard/funnel-velocity", (_req, res) => {
  res.json([
...
router.get("/dashboard/channel-performance", (_req, res) => {
  res.json([
    {
      name: "Sito Web",
      icon: "globe",
      ...
      sqls: 210,
      conversionRate: 24.9,
      pipelineContribution: 32,
      wonContribution: 28,
      roi: 5.2,
      trend: "up",
      avgConversionDays: 28,
    },
    {
      ...
      sqls: 185,
      conversionRate: 28.3,
      pipelineContribution: 22,
      wonContribution: 25,
      roi: 4.8,
      trend: "up",
      avgConversionDays: 21,
    },
    {
      name: "Advertising",
      icon: "megaphone",
    ...
    },
    {
      ...
      sqls: 42,
      conversionRate: 29.0,
      pipelineContribution: 5,
      wonContribution: 4,
      roi: 2.1,
      trend: "down",
      avgConversionDays: 45,
    },
    {
      name: "Outbound",
      icon: "phone",
      ...
      roi: 4.2,
      trend: "up",
      avgConversionDays: 42,
    },
  ]);
});

router.get("/dashboard/top-channels", (_req, res) => {
  res.json({
    topChannels: [
      {
      ...
      {
        name: "Email Outreach",
        subtitle: "Warm sequence conversion",
        leads: 280,
        cpl: 18.8,
        trend: "up",
      },
    ...
    underperformingChannels: [
      {
        name: "Meta Ads",
        subtitle: "Relevance score fatigue",
        leads: 45,
        cpl: 145.0,
        trend: "down",
      },
      {
        ...
        subtitle: "Tracking pixel leakage",
        leads: 12,
        cpl: 310.0,
        trend: "down",
      },
      {
        name: "Affiliate Network B",
        subtitle: "Quality score decay",
        leads: 68,
        cpl: 98.5,
        trend: "down",
      },
